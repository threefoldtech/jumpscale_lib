...
class GedisFactory(JSConfigBase):
    ...
    def new(
        ...
        src = j.clients.git.getContentPathFromURLorPath("https://github.com/threefoldtech/jumpscale_lib/tree/development/apps/template")
        dest = path
    ...
    def test(self,zdb_start=True):
        ...
        dest =  j.clients.git.getContentPathFromURLorPath("https://github.com/threefoldtech/jumpscale_lib/tree/development/apps/example")
