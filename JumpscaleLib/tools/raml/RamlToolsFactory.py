...
class RamlToolsFactory(JSBASE):
    ...
    def _check(self):
        ...
        if rc > 0:
            raise RuntimeError("Cannot find go-raml, please call 'js_raml install'")
    ...
    def get(self, path="", init=False):
        ...
        if init:
            ...
            self.logger.debug("now edit main.raml in api_spec director, and run 'js_raml generate_pyserver or other")
