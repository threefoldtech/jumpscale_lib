...
from JumpscaleLib.clients.blockchain.tfchain import const
from JumpscaleLib.clients.blockchain.tfchain import utils
from JumpscaleLib.clients.blockchain.tfchain.merkletree import Tree
from JumpscaleLib.clients.blockchain.tfchain.encoding import binary
from JumpscaleLib.clients.blockchain.tfchain.errors import RESTAPIError, InsufficientWalletFundsError
from JumpscaleLib.clients.blockchain.tfchain.types.unlockhash import UnlockHash, UNLOCK_TYPE_MULTISIG
...
class TfchainMultiSignatureWallet:
    ...
    def __init__(self, cosigners, required_sig, bc_networks, bc_network_password, minerfee=100000000, client=None):
        ...
        @param client: Name of the insance of the j.clients.tfchain that is used to create the wallet
        """
