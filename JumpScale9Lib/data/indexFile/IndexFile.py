...
class IndexFile(JSBASE):
    ...
    def iterate(self, method, start=0, end=0):
        ...
        call for each item:
            ...
            '''
        result is the result of the previous call to the method, for first iteration it is None
        ...
        """
        id = start
        self._f.seek(self._offset(start))
        result = None
