...
class MarkDownDocs(JSBASE):
    ...
    def macros_load(self, pathOrUrl=""):
        ...
        e.g. https://github.com/threefoldtech/jumpscale_lib9/markdowndocs/tree/master/examples
        """
    ...
    #     """
    #     js9 'j.tools.markdowndocs.generate_examples()'
    #     """
    ...
    #     """
    #     js9 'j.tools.markdowndocs.generate_jsdoc()'
    #     """
    ...
    #     js9 'j.tools.markdowndocs.generate()'
    ...
    #     """
    #     js9 'j.tools.markdowndocs.install()'
    #     """
